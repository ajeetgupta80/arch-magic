...
/* screenshot*/
static const char *screenshot[] = {"scrot", "/home/ajeet/Pictures/Screenshots/%Y-%m-%d-%T-screenshot.png",NULL};
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_equal,  spawn,          SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +5%") },
